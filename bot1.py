    ...
    async def confirm_cancel(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if penalty > 0:
            ...
            try:
                ...
                await asyncio.sleep(15)
                if original_msg and original_msg.flags.ephemeral:
...
class TransferCoinsModal(discord.ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            ...
            if interaction.response.is_ephemeral():
                await asyncio.sleep(15)
                try:
                    await interaction.delete_original_response()
                except Exception:
...
class ControlPanelView(discord.ui.View):
    ...
    async def case_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if rand <= c1:
            ...
            if mood == "angry":
                image_url = "https://shorturl.at/BdNto"
...
async def setup_hub(ctx):
    ...
    if not description:
        description = (
            "# <:coin21Photoroom:1515333202787700930> **متجر العملات | Coins Shop** <:coin21Photoroom:1515333202787700930>\n"
            "* **هنا تجد نظام متجر العملات الخاص بسيرفرنا:**\n"
            "* **ماذا يوجد هنا؟:** نظام تجميع عملات يتم تجميعها من تفاعلك بالسيرفر\n"
            "* **ماذا يمكنك الشراء؟:** ينمكنك شراء ادوات, رولات ممتعة حماسية تتيح لك باستعمالهم داخل السيرفر\n"
            "* **للمزيد من المعلومات اضغط زر الـ <:info128:1515378100056100915> في الأسفل!**\n"
            "\n"
            "* **Here you can find our server's coin shop system:**\n"
            "* **What is here?:** A coin collection system where you earn coins just by being active and interacting in the server.\n"
            "* **What can you buy?:** You can buy items and fun, exciting rolls that you can use inside the server.\n"
            "* **For more information, click the <:info128:1515378100056100915> button below!**"
        )
...
BOT.run("MTUxNTI5Njk4MzQzNzQxMDMzNw.Gl-iok.639cDN2yeuWGLDn2x6xoQJ46teQOSVDnNDyT9g")